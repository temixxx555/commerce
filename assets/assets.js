...
import girl_with_headphone_image from "./3.jpeg";
import girl_with_earphone_image from "./2.jpeg";
...
import boy_with_laptop_image from "./1.jpeg";
...
import outdoor from "./outdoor2.jpg";
import outdoor2 from "./outdoor.jpg";
...
export const ServicesIcon = () => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin='round'
      strokeWidth='1.5'
      d='M19.2 15.75a1.74 1.74 0 0 0 .1-2.85 6.96 6.96 0 0 0 .05-1.8 1.75 1.75 0 0 0-1.17-2.12 7.2 7.2 0 0 0-.88-1.52 1.75 1.75 0 0 0-2.14-.5 6.96 6.96 0 0 0-1.55-.6 1.74 1.74 0 0 0-3.3 0 6.96 6.96 0 0 0-1.55.6 1.75 1.75 0 0 0-2.14.5c-.33.45-.63.95-.88 1.52a1.75 1.75 0 0 0-1.17 2.12 6.96 6.96 0 0 0 .05 1.8 1.74 1.74 0 0 0 .1 2.85c.23.53.51 1.02.82 1.5a1.75 1.75 0 0 0 .83 2.55c.5.18 1.02.33 1.56.45a1.75 1.75 0 0 0 2.12 1.17 6.96 6.96 0 0 0 1.8-.05 1.74 1.74 0 0 0 2.85-.1c.53-.23 1.02-.51 1.5-.82a1.75 1.75 0 0 0 .55-2.14 6.96 6.96 0 0 0 .6-1.55Z'
    />
  </svg>
);
...
export const BlogIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin='round'
      strokeWidth='1.5'
      d='M15 3H6a1 1 0 0 0-1 1v16c0 .6.4 1 1 1h12a1 1 0 0 0 1-1V9l-6-6Z'
    />
    <path
      stroke='currentColor'
      strokeLinecap='round'
...
export const productsDummyData = [
  {
    ...
    name: "Chafing Dish",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sit amet tellus nec sem fermentum pulvinar. Vivamus in justo id metus tincidunt malesuada.",
    price: 10.0,
    offerPrice: 6.0,
    image: [
